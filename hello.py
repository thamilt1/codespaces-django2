...
interests_list = pd.read_csv('interests.csv')
classes_list = pd.read_csv('classes.csv')

interest_cats = interests_list['Type'].unique()
class_cats = classes_list['Type'].unique().tolist()
print(class_cats)

xx = classes_list.loc[classes_list.Type=='Science'].values

yy = dict(enumerate(xx.flatten(), 1))

print()

#print(classes_list['Type' == 'Science'])

#np_classes = np.array(classes_list)

#if np_classes[][0]=="World Language":
    #xx = []

#print(interests_list.to_string())
#print(classes_list.to_string())
#print(classes_list['type' == 'World Language'])
